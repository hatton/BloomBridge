...
export const optionsSchema: OptionSpec[] = [
  ...
  },
  {
    ...
    default: "off",
    choices: [
      { value: "off", label: "Off — never flatten" },
      { value: "0", label: "0 — every canvas page" },
      { value: "1", label: "1 — flatten readily" },
      { value: "2", label: "2" },
      { value: "3", label: "3" },
      { value: "4", label: "4" },
      { value: "5", label: "5 — only most complex" },
    ],
    stage: "html",
    help: "When a page is too complex to rebuild as editable HTML, import it as a single full-page image instead. Lower numbers flatten more readily; 0 flattens every canvas page; off never does.",
  },
  {
    key: "target",
    cliFlag: "--target",
