 ...
 * deterministic — far more reliable than asking the vision model for a "dominant"
 * color, which returned the average color of illustrations.
 */
async function detectSolidBackgroundColor(jpgPath: string): Promise<string | undefined> {
  try {
